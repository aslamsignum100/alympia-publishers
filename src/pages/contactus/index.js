                    ...
                    <div className="row ">
                      ...
                      <div className="col-md-4">
                        <div className='contact__col'>
                          ...
                          <p className='font-size-28' dangerouslySetInnerHTML={{ __html: data.mainheading.caption }}>
                            {/* {data.mainheading.caption} */}
                          </p>
                          <div className='enguaries mt-5 pt-3'>
                            <h5 className='font-size-28 font-700'>{data.enquaries.heading}</h5>
                            <p className='font-size-28'>{data.enquaries.caption}</p>
                          </div>
                          <div className='submission mt-5 pt-3'>
                            <h5 className='font-size-28 font-700'>{data.submission.heading}</h5>
                            <p className='font-size-28'>{data.submission.caption}</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className='contact__col'>
                          ...
                          <div className='speak__to__to mt-4'>
                          ...
                          <div className='holidays__caption mt-4'>
                            <p className='font-size-28'>
